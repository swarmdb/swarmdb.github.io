...
Swarm employs a variant of Lamport timestamps to identify events. In our past projects we used Lamport timestamps literally defined as a pair of integers. That approach was not rich enough for the general case, so finally we settled no the following scheme:
